...
the fix for exactly the kind of drift that caused `heading-h2`'s Extrabold-vs-Bold conflict
...
(`display-large`, `heading-h1`, `heading-h5`, `heading-h6`, `paragraph-medium`) remain genuinely
